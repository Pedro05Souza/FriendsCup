...
export class ChampionshipController {
    ...
    @Post()
    async createChampionship(@Body() createChampionshipDto: CreateChampionshipDto): Promise<void> {
        await this._createChampionshipUsecase.createChampionship(createChampionshipDto);
    }
